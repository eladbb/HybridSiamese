...
dagNet.addLayer('softMaxLossLayer', softMaxLossLayer, {'cnv9_Scores_siamese_x','labels'}, {'objective'}, {});
dagNet.addLayer('error', dagnn.Loss('loss', 'classerror'), {'cnv9_Scores_siamese_x','labels'}, 'error') ;
